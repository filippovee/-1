...
$user=array(
    'USER_LOGIN'=>'sfg@aaa.ru', #Ваш логин (электронная почта)
    'USER_HASH'=>'7a14afda87bb41c01e872d387cd911ddfa6ca621' #Хэш для доступа к API (смотрите в профиле пользователя)
);
$subdomain='sfgamo'; #Наш аккаунт - поддомен
